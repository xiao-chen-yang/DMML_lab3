...
To decide the value of $k$ in $k$-NN, we will follow steps 1 and 2 as described above. That is, evaluate the performance of $k$-NN on the validation set or using cross-validation for a range of $k$ and select the optimal $k$ that returns the smallest validation error rate.  
